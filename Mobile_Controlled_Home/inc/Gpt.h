...
typedef enum
{
    ...
    GPT_COMP_OUT_MODE_DISCONNECTED_OC1A,
    GPT_COMP_OUT_MODE_TOGGLE_OC1A,
    GPT_COMP_OUT_MODE_CLEAR_OC1A,
    GPT_COMP_OUT_MODE_SET_OC1A,
    GPT_COMP_OUT_MODE_DISCONNECTED_OC1B,
    GPT_COMP_OUT_MODE_TOGGLE_OC1B,
    GPT_COMP_OUT_MODE_CLEAR_OC1B,
    GPT_COMP_OUT_MODE_SET_OC1B,
