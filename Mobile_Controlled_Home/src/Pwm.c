...
void Pwm_Init(Pwm_ChannelType channel, Pwm_ModeType mode)
{
    ...
    case PWM_CHANNEL_OC1A:
    {
        ...
        switch (mode)
        {
        case PWM_MODE_PHASE_CORRECT_8_BIT:
            SET_BIT(TCCR1A, 0);
            CLR_BIT(TCCR1A, 1);
            CLR_BIT(TCCR1B, 3);
            CLR_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_PHASE_CORRECT_9_BIT:
            CLR_BIT(TCCR1A, 0);
            SET_BIT(TCCR1A, 1);
            CLR_BIT(TCCR1B, 3);
            CLR_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_PHASE_CORRECT_10_BIT:
            SET_BIT(TCCR1A, 0);
            SET_BIT(TCCR1A, 1);
            CLR_BIT(TCCR1B, 3);
            CLR_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_FAST_8_BIT:
            SET_BIT(TCCR1A, 0);
            CLR_BIT(TCCR1A, 1);
            SET_BIT(TCCR1B, 3);
            CLR_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_FAST_9_BIT:
            CLR_BIT(TCCR1A, 0);
            SET_BIT(TCCR1A, 1);
            SET_BIT(TCCR1B, 3);
            CLR_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_FAST_10_BIT:
            SET_BIT(TCCR1A, 0);
            SET_BIT(TCCR1A, 1);
            SET_BIT(TCCR1B, 3);
            CLR_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_PHASE_FREQUENCY_CORRECT_ICR1:
            CLR_BIT(TCCR1A, 0);
            CLR_BIT(TCCR1A, 1);
            CLR_BIT(TCCR1B, 3);
            SET_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_PHASE_CORRECT_ICR1:
            CLR_BIT(TCCR1A, 0);
            SET_BIT(TCCR1A, 1);
            CLR_BIT(TCCR1B, 3);
            SET_BIT(TCCR1B, 4);
        ...
        case PWM_MODE_FAST_ICR1:
            ...
            SET_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_PHASE_FREQUENCY_CORRECT_OCR1A:
            SET_BIT(TCCR1A, 0);
            CLR_BIT(TCCR1A, 1);
            CLR_BIT(TCCR1B, 3);
            SET_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_PHASE_CORRECT_OCR1A:
            SET_BIT(TCCR1A, 0);
            SET_BIT(TCCR1A, 1);
            CLR_BIT(TCCR1B, 3);
            SET_BIT(TCCR1B, 4);
            break;
        case PWM_MODE_FAST_OCR1A:
            SET_BIT(TCCR1A, 0);
            SET_BIT(TCCR1A, 1);
            SET_BIT(TCCR1B, 3);
            SET_BIT(TCCR1B, 4);
    ...
    {
        Dio_SetPinMode(PWM_PIN_OC2, DIO_MODE_OUTPUT);
        CLR_BIT(TCCR2, 4);
        SET_BIT(TCCR2, 5);
        switch (mode)
        {
